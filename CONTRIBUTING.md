...
- 中文是主文档语言，英文只作为翻译副本或辅助文档。
- 英文文档统一放在 `docs/en/`，不要与中文主文档平铺在仓库根目录，也不要把中英文说明混在同一正文段落中。
- 中文主文档顶部应提供到英文副本的相对链接，英文副本顶部应提供回中文主文档的相对链接。
- 新增或调整 README、贡献指南、安全策略、支持说明、行为准则、构建说明、架构说明、发布准备说明、Bug 报告指南或变更记录时，同步检查对应英文副本和语言切换链接。
