...
public class SchemaParser
{
    ...
    private List<SchemaElement> invokeParser( String schemaName ) throws IOException, ParseException
    {
        ...
        {
            String msg = I18n.err( I18n.ERR_06002_PARSER_FAILURE, schemaName, ExceptionUtils.getStackTrace( re ) );
            init();
            throw new ParseException( msg, re.getColumn() );
        }
        catch ( TokenStreamException tse )
        {
            String msg = I18n.err( I18n.ERR_06002_PARSER_FAILURE, schemaName, ExceptionUtils.getStackTrace( tse ) );
            init();
